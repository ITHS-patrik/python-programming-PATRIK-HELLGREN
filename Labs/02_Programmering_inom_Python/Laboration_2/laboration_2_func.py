...
def plot_data(train_x, train_y, train_z, test_x, test_y, predictions, pokemon_1NN, pokemon_10NN, input_x, input_y):
...
input_x, input_y, distances, pokemon_1NN, pokemon_10NN = user_input(training_points, training_labels)
reflection()

# PLOT DATA
plot_data(train_x, train_y, train_z, test_x, test_y, predictions, pokemon_1NN, pokemon_10NN, input_x, input_y)
